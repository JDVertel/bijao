    ...
    <div class="accordion" id="accordionAdmin">
                ...
                <div class="accordion-body">
                    <div class="container">
                        ...
                        <div class="container data" v-if="this.selectedEvent != ''">
                            <div class="row">
                                <div class="col-2">
                                    <button class="btn btn-danger redondo" @click="volverInv()">
        ...
        <div class="accordion-item">
            ...
            <div id="collapseProd" class="accordion-collapse collapse" data-bs-parent="#accordionAdmin">
                <div class="accordion-body">
                    <!-- Nav tabs -->
                    <button class="btn btn-success redondo" @click="newProd()" v-if="!gestprod">
                    ...
                    <div class="row">
                        ...
                        <div class="row titular" v-if="gestprod === 1">
                            ...
                            <button class="btn btn-danger redondo" @click="cerrar()">
                                <i class="fa fa-times" aria-hidden="true"></i></button>
                            ...
                            <table class="table table-sm">
                                ...
                                <tbody>
                                    <tr v-for="item in listProductos" v-bind:key="item.id">
                                        ...
                                        <td>
                                            <div class="row">
                                                <button class="btn btn-danger redondo">
                                                    <i class="fa fa-trash" aria-hidden="true" @click="eliminarProd(item.id, item.urlimagen)"></i>
                                                </button>
                                                <button class="btn btn-warning redondo" @click="editProd(item, item.id)">
                                ...
                                <tbody>
                                    <tr v-for="users in listUser" v-bind:key="users.id">
                                        ...
                                        <td>
                                            ...
                                            <button class="btn btn-info redondo" @click="Bloq_Desb_User(users.id, users.estado)" v-if="users.estado == true">
                                                <i class="fa fa-user" aria-hidden="true"></i>
                                            </button>
    
                                            <button class="btn btn-warning redondo" @click="Bloq_Desb_User(users.id, users.estado)" v-if="users.estado == false">
                                                <i class="fa fa-user-times" aria-hidden="true"></i>
                                            </button>
                                        </td>
                                        <td>
                                            <div class="row">
                                                <button class="btn btn-danger redondo" @click="eliminaruser(users.id)">
                                ...
                                <tbody>
                                    <tr v-for="event in listEventos" v-bind:key="event.id">
                                        ...
                                        <td>
                                            ...
                                            <div class="row">
                                                <button class="btn btn-info redondo" @click="Bloq_Desb_Event(event.id, event.estado)" v-if="event.estado == true">
                                                    <i class="fa fa-check" aria-hidden="true"></i>
                                                </button>
    
                                                <button class="btn btn-warning redondo" @click="Bloq_Desb_Event(event.id, event.estado)" v-if="event.estado==false">
